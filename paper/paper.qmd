...
The indicators varaiables intubated, hospitalized, and ICU tracks if a person required severe medical attention during their COVID case. Most cases in Toronto did not require severe medical attention but a total number of 18735 required some type of medical attention as seen in @tbl-medical-attention.
...
When we analyzed the yearly distribution of COVID 19 it had a bell shaped curve, however COVID fatality decreased every year during the pandemic due to Toronto's lockdown measures.
